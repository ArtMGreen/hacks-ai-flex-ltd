...
class QGen:
    ...
    def __init__(self):
        ...
        self.tokenizer = T5Tokenizer.from_pretrained("tokenizers/t5-base")
        model = T5ForConditionalGeneration.from_pretrained("models/Parth-result")
        ...
        self.set_seed(randint(1, 1000000))
...
class AnswerPredictor:
    ...
    def __init__(self):
        self.tokenizer = T5Tokenizer.from_pretrained('tokenizers/t5-base')
        model = T5ForConditionalGeneration.from_pretrained('models/Parth-boolean')
        device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
        model.to(device)
        # model.eval()
        self.device = device
